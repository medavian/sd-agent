...
class checks:
    ...
    def getPlugins(self):
        ...
        if 'pluginDirectory' in self.agentConfig and self.agentConfig['pluginDirectory'] != '':
            ...
            if not os.access(self.agentConfig['pluginDirectory'], os.R_OK):
